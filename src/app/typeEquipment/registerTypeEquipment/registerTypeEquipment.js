...
export default function RegisterTypeEquipment({token}) {
    ...
    const addTypeEquipment = async () => {
        ...
        await addData(`http://${process.env.NEXT_PUBLIC_LOCALHOST}:3001/addTypeEquipment`, data, token, setResult)
        setIsModalOpen(true)
    }
    ...
    return (
        <section className="bg-gray-100 py-3 w-full">
            <div className="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-lg" >
                <h1 className="text-2xl font-semibold text-center text-gray-800 mb-6">Adicionar Tipo de Equipamento </h1>
                ...
                <div className="mb-6">
                    <button onClick={addTypeEquipment} className="w-full mt-6 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 roundedw-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 ">Cadastrar</button>
                </div>
