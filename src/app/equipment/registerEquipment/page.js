...
export default async function RegisterEquipment() {
    ...
    return (
        <PageRegisterEquipment dataUser={user} dataBranch={branch} dataSector={sector} dataSupplier={supplier} dataTypeEquipment={typeEquipment} dataSituation={situation} token={token} ></PageRegisterEquipment>
    )
}