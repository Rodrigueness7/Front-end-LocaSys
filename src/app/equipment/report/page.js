...
export default function Report() {
    ...
    useEffect(() => {
        const storedData = sessionStorage.getItem('dataEquipment')
    ...
    return(
        <>
         {data !== null && (
            <LargePdfTable data={data} size={'A4'} user={user} title={'Relátorio de Equipamento'} width={'25%'} row={4}></LargePdfTable>
         )}
        </>
    )
}